...
comment on column T_TEMP_COMPCLIENTTRADE.ORDERID is '';
comment on column T_TEMP_COMPCLIENTTRADE.SEATNO is '';
...
comment on column H_EXCUSTOMER.SECURITIES is '客户证券账户';
...
comment on column H_EXSETRDDATA.SECURIACCOUNT is '客户证券账户';
...
comment on column H_EXSEPOSDATA.SECURIACCOUNT is '客户证券账户';
...
comment on column D_EXCUSTOMER.SECURITIES is '客户证券账户';
...
comment on column D_EXSETRDDATA.SECURIACCOUNT is '客户证券账户';
...
comment on column D_EXSEPOSDATA.SECURIACCOUNT is '客户证券账户';
